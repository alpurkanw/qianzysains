...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <a href="<?= base_url(); ?>" class="get-started-btn scrollto">
                Kembali</a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <img class="img img-thumbnail shadow " style="max-width: 450px;" src="<?= base_url("assets/compro/assets/img/team/") . $team['gambar']; ?>" alt="">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <strong>Nama</strong>
                                        <p class="text-left"><?= $team["nama"]; ?></p>
                                        <strong>Jabatan</strong>
                                        <p class="text-left"><?= $team["jabatan"]; ?></p>
                                        <strong>My Profile </strong>
                                        <p>
                                            <a href="<?= $team["fb"]; ?>" class="btn btn-outline-warning p-1" target="_blank" rel="noopener noreferrer">
                                                <i class="bx bx-sm bxl-facebook "></i>
                                            </a>
                                            <a href="<?= $team["ig"]; ?>" class="btn btn-outline-warning p-1" target="_blank" rel="noopener noreferrer">
                                                <i class="bx bx-sm bxl-instagram "></i>
                                            </a>
                                            <a href="<?= $team["twt"]; ?>" class="btn btn-outline-warning p-1" target="_blank" rel="noopener noreferrer">
                                                <i class="bx bx-sm bxl-twitter "></i>
                                            </a>
                                        </p>

                                        <strong>Deskripsi :</strong>
                                        <p class="text-left"><?= $team["ket"]; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
